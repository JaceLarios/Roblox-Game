...
The earlier procedural versions remain backed up under `assets/legendary-jets` and in Studio ServerStorage. These replacements are installed with revision `LegendaryFullBody_20260923_v3`. Roblox publishing is separate.
